...
| **[Lore](./lore)** 📜                                            | Skill | [Open](./lore)                                                                                       | Any [Agent Skills](https://agentskills.io) harness (Claude Code, Codex, Cursor, Gemini CLI, …) | Node 22.5+   | `npx skills add specstoryai/getspecstory --skill lore`        | [📋 View](./lore/CHANGELOG.md)                                                             |
