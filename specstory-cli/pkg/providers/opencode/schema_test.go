		...
		Messages: []FullMessage{
			...
			},
			{
				Message: &Message{
					...
					Time:      MessageTime{Created: 1735725601000},
				},
				Parts: []Part{
					{
						ID:   "prt_002",
...
func TestBuildExchangesFromMessages(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			messages: []FullMessage{
				{
					Message: &Message{ID: "msg_1", Role: RoleUser, Time: MessageTime{Created: 1735725600000}},
					Parts:   []Part{{ID: "prt_1", Type: PartTypeText, Text: &userText}},
				},
				{
					Message: &Message{ID: "msg_2", Role: RoleAssistant, Time: MessageTime{Created: 1735725601000}},
		...
		},
		{
			...
			messages: []FullMessage{
				...
				{
					Message: &Message{ID: "msg_3", Role: RoleUser, Time: MessageTime{Created: 1735725602000}},
					Parts:   []Part{{ID: "prt_3", Type: PartTypeText, Text: &userText2}},
				},
				{
					Message: &Message{ID: "msg_4", Role: RoleAssistant, Time: MessageTime{Created: 1735725603000}},
		...
		},
		{
			...
			messages: []FullMessage{
				{
					Message: &Message{ID: "msg_1", Role: RoleAssistant, Time: MessageTime{Created: 1735725600000}},
