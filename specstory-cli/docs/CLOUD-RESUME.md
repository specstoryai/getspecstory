...
> Status: **DRAFT** — design converged (D1–D36), no open questions, implementation plan in §4 (five development chunks). Chunks 1–4 implemented; Chunk 5 (resume by session URI) implemented.
